    ...
    metadata: [
      {
        name: "keywords",
        content:
          "physical AI, humanoid robotics, artificial intelligence, robotics, machine learning, computer science, engineering, technology",
      },
      {
        name: "description",
        content:
          "Learn about Physical AI and Humanoid Robotics - bridging digital minds to physical bodies through advanced robotics and AI technologies",
      },
      { name: "author", content: "Physical AI & Humanoid Robotics Book" },
      { name: "og:title", content: "Physical AI & Humanoid Robotics" },
      {
        name: "og:description",
        content: "Bridging Digital Minds to Physical Bodies",
      },
      { name: "og:type", content: "website" },
      {
        name: "og:url",
        content: "https://abdullah2127x.github.io/human-robotics-book/",
      },
    ],
    ...
    headTags: [
      {
        tagName: "noscript",
        innerHTML:
          "<style>.hero__title { font-size: 2rem; } .hero__subtitle { font-size: 1.2rem; } .button { display: inline-block; padding: 0.5rem 1rem; } .features { display: block; } .col { display: block; width: 100%; margin-bottom: 2rem; }</style>",
      },
    ],
    navbar: {
      title: "Physical AI & Humanoid Robotics",
